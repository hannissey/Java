...
public class ChangingFace2 extends Application {
    ...
    public void start(Stage stage)
    {
        ...
        // create buttons that will make face smile or frown
        ...
        // add buttons to horizontal container
        ...
        smileButton.setOnAction(e ->
                {   // Arc mouth = new Arc(125, 150, 45, 35, 0, -180);
                    mouth.setCenterX(125);
                    mouth.setCenterY(150);
                    mouth.setRadiusX(45);
                    mouth.setRadiusY(35);
        ...
        thinkButton.setOnAction(e ->
                {
                    mouth.setRadiusX(30); // width
                    mouth.setRadiusY(0); //height
                }
